...
class HXCPP_CLASS_ATTRIBUTES  DocumentClass_obj : public ::jigsawxtargets::hxopenfl::JigsawxOpenfl_obj{
	public:
		typedef ::jigsawxtargets::hxopenfl::JigsawxOpenfl_obj super;
