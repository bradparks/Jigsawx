...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("justinfront"),HX_CSTRING("Jigsawx"),HX_CSTRING("net.justinfront.jigsawx"),HX_CSTRING("1.0.0"));
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",32);
			{
				...
				HX_STACK_LINE(68)
				{
					...
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::jigsawxtargets::hxopenfl::JigsawxOpenfl >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(68)
					while(((_g < _g1->length))){
						HX_STACK_LINE(68)
				...
				if ((hasMain)){
					HX_STACK_LINE(79)
					::Reflect_obj::callMethod(hx::ClassOf< ::jigsawxtargets::hxopenfl::JigsawxOpenfl >(),::Reflect_obj::field(hx::ClassOf< ::jigsawxtargets::hxopenfl::JigsawxOpenfl >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(85)
		...
		HX_STACK_LINE(32)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)600,(int)30,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("JigsawX"),null(),null());
	}
return null();
}
