...
const char *__hxcpp_all_files[] = {
	...
	"haxe/Timer.hx",
	"jigsawx/JigsawPiece.hx",
	"jigsawx/JigsawSideData.hx",
	"jigsawx/Jigsawx.hx",
	"jigsawx/OpenEllipse.hx",
	"jigsawx/ds/CircleIter.hx",
	"jigsawx/math/Vec2.hx",
	"jigsawxtargets/hxopenfl/JigsawxOpenfl.hx",
	"openfl/Assets.hx",
