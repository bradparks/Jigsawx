...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("justinfront", "Jigsawx", "net.justinfront.jigsawx", "1.0.0");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (jigsawxtargets.hxopenfl.JigsawxOpenfl)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (jigsawxtargets.hxopenfl.JigsawxOpenfl, Reflect.field (jigsawxtargets.hxopenfl.JigsawxOpenfl, "main"), []);
...
@:keep class DocumentClass extends jigsawxtargets.hxopenfl.JigsawxOpenfl {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "JigsawX", null, { width: 800, height: 600 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (jigsawxtargets.hxopenfl.JigsawxOpenfl, []);
			}
...
import jigsawxtargets.hxopenfl.JigsawxOpenfl;
